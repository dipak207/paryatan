...
export default async function Home() {
  let featuredDestinations: FeaturedDestination[] = [];
        ...
        <section className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          <div className="space-y-6">
            ...
            <p className="max-w-2xl text-lg leading-8 text-on-surface-variant">
              Paryatan brings travel discovery, weather insights, favorites,
              and trip planning together in one modern experience.
            </p>
            ...
            <div className="grid gap-4">
              ...
              <div className="rounded-3xl border border-border bg-surface-container-high p-6">
                ...
                <p className="mt-3 text-base leading-7 text-on-surface">
                  Get destination weather, notes, and recommendations from one
                  place.
                </p>
              </div>
            </div>
          ...
          <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <h2 className="text-3xl font-semibold text-foreground">
                Curated destination picks
              </h2>
            </div>

            <p className="text-sm text-on-surface-variant">
              Browse top destinations and save favorites as you go.
            </p>
          </div>
          ...
          {featuredDestinations.length > 0 ? (
            ...
            <div className="rounded-3xl border border-border bg-surface p-8 text-center">
              <h3 className="text-xl font-semibold text-foreground">
                Featured destinations could not be loaded.
              </h3>

              <p className="mt-2 text-sm text-on-surface-variant">
                Please check your API keys and try searching manually.
              </p>
